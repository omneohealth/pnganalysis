...
plot(province, lwd = 1, border = "gray50", 
     col = ifelse(province@data$ADM1_PCODE %in% c("01", "05", "10", "blue")
#
# province pcode 08, 09, 20, 22, in green, rest blue
#
plot(province, lwd = 1, border = "gray50", 
     col = ifelse(province@data$ADM1_PCODE %in% c("08", "09", "20", "22", "red"))

# create sample data for immunization coverage per province
